<template>
  <v-card color="blue lighten-2" dark outlined>
    <v-card-title class="headline blue lighten-3 d-flex justify-space-between ml-n3 mr-n3">
        ...
        <v-row no-gutters>
          ...
          >
            <v-card class="pa-5 blue darken-1" outlined>
              ...
              <v-card-text
                class="headline pa-0"
              >{{city.population.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ")}}</v-card-text>
              <v-spacer class="pa-2"></v-spacer>

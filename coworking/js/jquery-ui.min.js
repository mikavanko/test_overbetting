    ...
    $.mousedirection = function (opts) {
        ...
        $(document).bind("mousemove", function (e) {
            ...
            if (e.pageX > oldx && e.pageY > oldy) {
            	exactDir = (e.PageX - oldx > e.pageY - oldy) ? "x" : "y";
                direction=exactDir;
            }
            else if (e.pageX > oldx && e.pageY < oldy) {
            	exactDir = (e.PageX - oldx > oldy - e.pageY) ? "x" : "y";
                direction=exactDir;
            }
            else if (e.pageX < oldx && e.pageY < oldy) {
            	exactDir = (oldx - e.PageX > oldy - e.pageY) ? "x" : "y";
                direction=exactDir;
            }
            else if (e.pageX < oldx && e.pageY > oldy) {
            	exactDir = (oldx - e.PageX > e.pageY - oldy) ? "x" : "y";
                direction=exactDir;
            }
            else if (e.pageX > oldx && e.pageY == oldy) {
                direction="x";
